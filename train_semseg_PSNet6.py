...
from data_utils_PSNet.PSNet6Dataloader import PSNetDataloader
import torch
import datetime
import logging
...
classes = ['duct','ibeam','pipe','pump','rectangularbeam','tank']
...
def main(args):
    ...
    root = 'data/PSNet_reduced_6/'
    NUM_CLASSES = 6
    NUM_POINT = args.npoint
    BATCH_SIZE = args.batch_size

    print("start loading training data ...")
    TRAIN_DATASET = PSNetDataloader(split='train', data_root=root, num_point=NUM_POINT, test_area=args.test_area, block_size=1.0, sample_rate=1.0, transform=None)
    print("start loading test data ...")
    TEST_DATASET = PSNetDataloader(split='test', data_root=root, num_point=NUM_POINT, test_area=args.test_area, block_size=1.0, sample_rate=1.0, transform=None)
